...
public:
    ...
    // terrain type icons:
    const Rect terrainTypeIcon1 = { TERRAIN_ICON1_X1,TERRAIN_ICON1_Y1,TERRAIN_ICON1_X2,TERRAIN_ICON1_Y2 };
    const Rect terrainTypeIcon2 = { TERRAIN_ICON2_X1,TERRAIN_ICON2_Y1,TERRAIN_ICON2_X2,TERRAIN_ICON2_Y2 };
    const Rect terrainTypeIcon3 = { TERRAIN_ICON3_X1,TERRAIN_ICON3_Y1,TERRAIN_ICON3_X2,TERRAIN_ICON3_Y2 };
    const Rect terrainTypeIcon4 = { TERRAIN_ICON4_X1,TERRAIN_ICON4_Y1,TERRAIN_ICON4_X2,TERRAIN_ICON4_Y2 };

    // mouse sensitive area's for map scrolling action:
    ...
    // terrain type mouse coords:
    const Rect terrainTypeIcon1AbsCoords = { TERRAIN_ICON1ABS_X1,TERRAIN_ICON1ABS_Y1,TERRAIN_ICON1ABS_X2,TERRAIN_ICON1ABS_Y2 };
    const Rect terrainTypeIcon2AbsCoords = { TERRAIN_ICON2ABS_X1,TERRAIN_ICON2ABS_Y1,TERRAIN_ICON2ABS_X2,TERRAIN_ICON2ABS_Y2 };
    const Rect terrainTypeIcon3AbsCoords = { TERRAIN_ICON3ABS_X1,TERRAIN_ICON3ABS_Y1,TERRAIN_ICON3ABS_X2,TERRAIN_ICON3ABS_Y2 };
    const Rect terrainTypeIcon4AbsCoords = { TERRAIN_ICON4ABS_X1,TERRAIN_ICON4ABS_Y1,TERRAIN_ICON4ABS_X2,TERRAIN_ICON4ABS_Y2 };
